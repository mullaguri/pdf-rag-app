...
export default function App() {
  ...
  const { messages, loading, sendMessage, clearMessages,
          ...
          modelParams, updateModelParam, resetModelParams,

          currentSessionId, setCurrentSessionId, startNewSession, clearHistory } = useChat(isAuthenticated);
  ...
  return (
    ...
    <div className="app-container" style={appStyle}>
      ...
      <UserDetails open={userDetailsOpen} onClose={() => setUserDetailsOpen(false)} user={user} onReset={fetchDocuments} />
            ...
            <div className="chat-header-right">
              ...
              <div className="session-controls">
                ...
                <div className="session-info">
                  ...
                  <span className="session-id">Session: {currentSessionId.slice(-8)}</span>

                  <button className="link-btn" onClick={startNewSession} title="Start new session">
